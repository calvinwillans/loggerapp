...
// Row numbers in Inputs column G decide the rows on every screen. Where no
// numbers are given, these stages fall back to starting a new row at each
// colour change, as does any folder (People, FOH and so on).
...
function renderStage() {
  ...
  // Row numbers from Inputs column G win over colour, on every screen:
